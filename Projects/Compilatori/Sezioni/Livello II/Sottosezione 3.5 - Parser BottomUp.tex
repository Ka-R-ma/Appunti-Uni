...
\subfile{../Livello III/Sottosottosezione 3.5.1 - Parser shiftReduce.tex}

\subsubsection{Grammatiche LR e parsing LR(k)}
\subfile{../Livello III/Sottosottosezione 3.5.2 - Grammatiche LR e parsing LR(k).tex}

\subsubsection{Altri parser SR}
\subfile{../Livello III/Sottosottosezione 3.5.3 - Altri parser SR.tex}
\end{document}